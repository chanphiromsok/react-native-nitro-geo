...
namespace margelo::nitro::nitrogeolocation {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "GeoCoordinates" and the the Kotlin data class "GeoCoordinates".
   */
  struct JGeoCoordinates final: public jni::JavaClass<JGeoCoordinates> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrogeolocation/GeoCoordinates;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct GeoCoordinates by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    GeoCoordinates toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JGeoCoordinates::javaobject> fromCpp(const GeoCoordinates& value) {
      using JSignature = JGeoCoordinates(double, double, double, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
